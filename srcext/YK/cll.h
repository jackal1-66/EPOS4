...
public :
  ...
  inline const double* getpi10(void) const { return pi; }
  ...
  inline void getQprev(double *_Qp) { for(int i=0; i<7; i++) _Qp[i] = Qprev[i] ; }
	...
	void getPrimVarFull(EoS *eos, double tau, double &_e, double &_p, double &_nb, double &_nq, double &_ns, double &_vx, double &_vy, double &_vz) ;
